"""
Glint360K 数据集 + ResNet-50 网络配置文件
用于在 Glint360K 人脸数据集上训练 ResNet-50 骨干网络的配置。
ResNet-50 是 50 层的深度残差网络，是人脸识别中最常用的骨干网络之一。
"""
...
config.network = "r50"                      # 骨干网络架构：ResNet-50（50层深度残差网络）
