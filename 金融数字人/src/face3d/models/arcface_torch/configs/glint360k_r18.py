"""
Glint360K 数据集 + ResNet-18 网络配置文件
用于在 Glint360K 人脸数据集上训练 ResNet-18 骨干网络的配置。
ResNet-18 是 18 层的轻量级残差网络，训练速度快但精度略低。
"""
...
config.network = "r18"                      # 骨干网络架构：ResNet-18（18层轻量残差网络）
