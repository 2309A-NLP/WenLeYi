"""
Glint360K 数据集 + ResNet-100 网络配置文件
用于在 Glint360K 人脸数据集上训练 ResNet-100 骨干网络的配置。
ResNet-100 是 100 层的深度残差网络，模型容量较大，识别精度高。
"""
